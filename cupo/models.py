...
class PlantillaXLS(models.Model):
    ...
    x_docente = models.CharField('', max_length=11, blank=True, null=True)
    departamento = models.CharField('', max_length=100, blank=True, null=True)
    x_departamento = models.CharField('', max_length=10, blank=True, null=True)
    fecha_inicio = models.CharField('', max_length=15, blank=True, null=True)
    fecha_fin = models.CharField('', max_length=15, blank=True, null=True)
    dia = models.CharField('', max_length=3, blank=True, null=True)
    hora_inicio = models.CharField('', max_length=15, blank=True, null=True)
    hora_fin = models.CharField('', max_length=15, blank=True, null=True)
    hora_inicio_cadena = models.CharField('', max_length=8, blank=True, null=True)
    hora_fin_cadena = models.CharField('', max_length=8, blank=True, null=True)
    actividad = models.CharField('', max_length=100, blank=True, null=True)
    x_actividad = models.CharField('', max_length=20, blank=True, null=True)
    l_requnidad = models.CharField('', max_length=2, blank=True, null=True)
    docencia = models.CharField('', max_length=2, blank=True, null=True)
    minutos = models.CharField('', max_length=15, blank=True, null=True)
    x_dependencia = models.CharField('', max_length=10, blank=True, null=True)
    c_coddep = models.CharField('', max_length=30, blank=True, null=True)
    x_dependencia2 = models.CharField('', max_length=10, blank=True, null=True)
    c_coddep2 = models.CharField('', max_length=30, blank=True, null=True)
    unidad = models.CharField('', max_length=20, blank=True, null=True)
    x_unidad = models.CharField('', max_length=11, blank=True, null=True)
    materia = models.CharField('', max_length=100, blank=True, null=True)
    x_materiaomg = models.CharField('', max_length=11, blank=True, null=True)
    curso = models.CharField('', max_length=100, blank=True, null=True)
    omc = models.CharField('', max_length=20, blank=True, null=True)
    grupo_materias = models.CharField('', max_length=50, blank=True, null=True)
