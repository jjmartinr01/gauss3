...
admin.site.register(PerfilSalida)
admin.site.register(CompetenciaClave)
admin.site.register(DescriptorOperativo)
admin.site.register(AreaMateria)
admin.site.register(CompetenciaEspecifica)
admin.site.register(CriterioEvaluacion)
admin.site.register(TablaCompetenciasClave)
