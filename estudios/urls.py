...
urlpatterns = [
    ...
    url(r'^configura_grupos/$', views.configura_grupos, name='configura_grupos'),
    # url(r'^define_materia/$', views.define_materia, name='define_materia'),
    url(r'^evaluar_materias/$', views.evaluar_materias, name='evaluar_materias'),
    url(r'^configura_materias_pendientes/$', views.configura_materias_pendientes, name='configura_materias_pendientes'),
]
