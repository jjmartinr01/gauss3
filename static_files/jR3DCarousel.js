		...
		(function setup(){
			...
			function _createControls(){
				...
				_previousButton.add(_nextButton)
							   .css({position: 'absolute', top:'50%', zIndex:1, transform: 'translateY(-50%)', fontSize: '4em', color: 'rgba(211, 211, 211, 0.97)', cursor:'pointer', userSelect: 'none'})
							   .appendTo(_container)
							   .hide();
				...
				_previousButton.hover(function(){
					_previousButton.css({color: 'rgba(128, 128, 128, 0.97)'});
				},function(){
					_previousButton.css({color: 'rgba(211, 211, 211, 0.97)'});
				});
				_nextButton.hover(function(){
					_nextButton.css({color: 'rgba(128, 128, 128, 0.97)'});
				},function(){
					_nextButton.css({color: 'rgba(211, 211, 211, 0.97)'});
				});
